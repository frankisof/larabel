...
<div class="container" >
    ...
    <form action="{{ route('pets.store') }}" method="POST" style="background-color: rgba(255, 255, 255, 0.9); padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            <label for="breed" style="font-weight: bold;color:black; margin-bottom: 5px; display: block;">Raza:</label>
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            <label for="age" style="font-weight: bold; color:black; margin-bottom: 5px; display: block;">Edad:</label>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            <label for="type" style="font-weight: bold; color:black; margin-bottom: 5px; display: block;">Tipo:</label>
